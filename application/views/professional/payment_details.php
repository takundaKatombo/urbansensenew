  ...
  <main id="content" role="main">
      <div class="container">
          ...
          <div class="row">
              <div class="col-md-12">
                  <h5 class="book">Payment Detail</h5>
              </div>
          </div>
          <div class="row">
              <div class="col-md-12">
                  <div class="card4">
                      <div class="row service">
                          <div class="col-md-6">
                              <h5>Payment ID</h5>
                              <p class="font-size-14"><?= $payment->payment_key ?></p>
                          </div>

                          <div class="col-md-6">
                              <h5>Price</h5>
                              <p class="font-size-14"><?= $payment->currency_type . ' ' . $payment->amount ?></p>
                          </div>
                      </div>
                      <div class="row service">
                          <div class="col-md-6">
                              <h5>Service</h5>
                              <p class="font-size-14"><?= get_service($payment->service_id) ?></p>
                          </div>
                          <div class="col-md-6">
                              <h5>Customer Name</h5>
                      ...
                      <div class="row service">
                          <div class="col-md-6">
                              ...
                              <p class="font-size-14"><?= date('d M Y | h:i a', strtotime($payment->created_at)) ?></p>
                          </div>
                          <div class="col-md-6">
                              <h5>Download Invoice</h5>
                              <p class="font-size-14"><a href="<?= base_url('professional/Dashboard/download_invoice/') . $payment->payment_key; ?>"><img src="<?= base_url('assets/download.png') ?>" width="150" height="70"></a></p>
                          </div>
