 ...
 <main id="content" role="main">
     ...
     <div class="container">
         ...
         <center>
             <a class="btn <?= ($this->uri->segment(1) == 'converted-leads') ? 'btn-primary' : 'btn-default' ?>" href="<?= base_url('converted-leads'); ?>">All Leads</a>

             <a class="btn <?= ($this->uri->segment(1) == 'today-converted-leads') ? 'btn-primary' : 'btn-default' ?>" href="<?= base_url('today-converted-leads'); ?>">Today Leads</a>

             <a class="btn <?= ($this->uri->segment(1) == 'yesterday-converted-leads') ? 'btn-primary' : 'btn-default' ?>" href="<?= base_url('yesterday-converted-leads'); ?>">Yesterday Leads</a>

             <a class="btn <?= ($this->uri->segment(1) == 'current-week-converted-leads') ? 'btn-primary' : 'btn-default' ?>" href="<?= base_url('current-week-converted-leads'); ?>">Current Week Leads</a>
         </center>
                             ...
                             <div class="card-body">
                                 ...
                                 <div>
                                     <p class="font-size-14">
                                         ...
                                         <?php } else if ($row->quote_request->status == 1) { ?>
                                             <span class="badge badge-success">ONGOING REQUEST</span>
                                         <?php } else if ($row->quote_request->status == 2) { ?>
