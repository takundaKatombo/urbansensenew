  					...
  					<div class="col-md-12">
  						<div class="card mb-3">
  							<div class="row  m-3">
  								...
  								<div class="col-md-1">
  									<h5>Price</h5>
  									<p class="font-size-14">ZAR <?= $row->amount_paid ?></p>
  								</div>
  								<div class="col-md-2">
  								...
  								<div class="col-md-2">
  									<a href="<?= base_url('booking-detail-view/') . $row->id ?>" class="btn btn-primary u-btn-primary transition-3d-hover but1">View Detail</a>
  								</div>
  							</div>
  						</div>
  					</div>
