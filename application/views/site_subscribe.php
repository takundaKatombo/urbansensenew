<div class="starter-template">
                ...
                <p class="lead" onclick="subscribe();">User Subscribe Page</p>
            </div>
            ...
            <div class="contact-form">
                ...
                <form id="ServiceRequest" action="<?= base_url() ?>api/PushNotification/send_message" method='post'>
                    ...
                    <div class="form-group">
                        <label class="control-label">Message Body:</label>
                        <input type="text" name="user_id" class="form-control" readonly value="2" >
                    </div>
...
<script>
  ...
  OneSignal.push(function() {
    OneSignal.init({
      appId: "23fc4864-d513-4ea9-948d-567fcd9cd3ae",
    });
  });
</script>
        <script src="https://cdn.onesignal.com/sdks/OneSignalSDK.js" async></script>
        ...
        <script>
            ...
            OneSignal.push(function() {
                ...
                OneSignal.on('subscriptionChange', function (isSubscribed) {
                    ...
                    OneSignal.sendTag("user_id","2", function(tagsSent)
                    {
