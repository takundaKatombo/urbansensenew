                        ...
                        <div class="table-responsive">
                           <table class="table table-bordered">
                            ...
                            <tbody>
                              <tr>
                                 <td><?= 'ZAR '. $price ?></td>
                                <td><?=  'ZAR '.$extra_work->total_amount ?></td>
                                <?php $amount_payable = $price - $extra_work->total_amount ?>
                                <td><?=  'ZAR '.$amount_payable ?></td>
                                <td><?=  'ZAR '.$amount_payable ?></td>
                              </tr>
                            </tbody>
                          </table>
                     ...
                     <div class="col-md-2">
                       ...
                       <div class=" col-md-10">
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <div class="mb-1 mr-1 bold">Payable Amount : <?=  'ZAR '.$amount_payable ?></div>
                                   ...
                                   <!--  <input type="hidden" name="return_url" value="<?= base_url('booking-successfull') ?>?txnid=<?= $payment_id.'_'.$amount_payable.'_'.$booking_id ?>">

                                    <input type="hidden" name="cancel_url" value="<?= base_url('booking-cancelled') ?>?txnid=<?= $payment_id.'_'.$amount_payable.'_'.$booking_id ?>">

                                    <input type="hidden" name="notify_url" value="<?= base_url('customer/Payments/itn') ?>" /> -->



                                     <input type="hidden" name="return_url" value="http://45.55.163.26/dev3/urbansense/booking-successfull?txnid=<?= $payment_id.'_'.$amount_payable.'_'.$booking_id ?>">

                                    <input type="hidden" name="cancel_url" value="http://45.55.163.26/dev3/urbansense/booking-cancelled?txnid=<?= $payment_id.'_'.$amount_payable.'_'.$booking_id ?>">
