      ...
      <div class="row">
               ...
               <article class="card-group-item">
                  ...
                  <div class="filter-content">
                     <div class="list-group list-group-flush">
                        ...
                        <a href="<?= base_url('services/').$row['slug'] ?>" class="list-group-item <?= ($service_title->id===$row['id']) ? 'active' : ''; ?>"><span class="float-left round mr-2"> <img src="<?= base_url('uploads/image/').$row['image']; ?>" width="25" height="25"> </span> <?= ucwords($row['title']); ?><span class="float-right badge badge-light round"></span> </a>
                        <?php } ?>
                     </div>
                     <!-- list-group .// -->
                  </div>
         ...
         <div class="col-12 col-sm-9">
            ...
            <div class="alert alert-info alert-dismissible">
             We are sorry, there are no service providers in your area, we are working on getting more. Please try again later. For a custom request
  <a href="<?= base_url('send-request'); ?>"><b>Click Here</b></a>
            </div>
                        ...
                        <div class="mr-3">
                           ...
                           <div class="d-sm-flex align-items-sm-center">
                              ...
                              <!--   <div class="u-ver-divider u-ver-divider--none-sm pr-4 mb-3 mb-sm-0 mr-4">
                                 <h4 class="small font-weight-normal text-secondary mb-0">Location</h4>
                                 <span class="text-dark"> <i class="fa fa-map-marker" aria-hidden="true"></i> <?= get_city($row->city_id); ?></span>
                                 </div> -->
                              <!-- End Budget -->
                              <!-- Priority -->
