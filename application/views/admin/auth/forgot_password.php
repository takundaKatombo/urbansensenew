...
<head>
    ...
    <title>UrbanSense | Forgot Password</title>
            ...
            <div class="col-lg-6 bg-white">
             <?php $this->load->view('errors/error'); ?> 
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form method="post" action="<?= base_url('admin/auth/forgot_password') ?>" class="form-validate">
                   
                    <div class="form-group">
                       <label for="email" class="label-material">Email</label>
                      <input id="email" type="text" name="email" required data-msg="Please enter your email" class="form-control">
                     
                    </div>
                    <button type="submit" id="login" class="btn btn-primary">Reset Password</button>
                    <!-- This should be submit button but I replaced it with <a> for demo purposes-->
                  </form><a href="<?= base_url('admin/auth/login') ?>" class="forgot-pass">Login?</a><br>
                </div>
              </div>
            </div>
          </div>
