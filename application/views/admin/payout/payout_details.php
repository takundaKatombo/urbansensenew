...
<header class="page-header">
   <div class="container-fluid">
      <h2 class="no-margin-bottom">Payout Details</h2>
         ...
         <div class="card">
            ...
            <div class="card-body">
               ...
               <hr>
                ...
                <div class="row">
                  <div class="col-md-6">Service Cost</div><div class="col-md-6"><?= $booking->amount_paid .' '.$booking->currency ?></div>
               </div>
               <hr>
               <div class="row">
